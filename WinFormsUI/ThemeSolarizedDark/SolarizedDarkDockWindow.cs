...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    internal class SolarizedDarkDockWindow : DockWindow
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolarizedDarkDockWindow"/> class.
        /// </summary>
        /// <param name="dockPanel">The dock panel.</param>
        /// <param name="dockState">State of the dock.</param>
        public SolarizedDarkDockWindow(DockPanel dockPanel, DockState dockState) : base(dockPanel, dockState)
        {
        }
        ...
        internal class SolarizedDarkDockWindowSplitterControl : SplitterBase
        {
