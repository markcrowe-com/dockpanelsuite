...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class SolarizedDarkDockPaneStrip : DockPaneStripBase
    {
        private class TabSolarizedDark : Tab
        {
            public TabSolarizedDark(IDockContent content)
                : base(content)
            {
            }
        ...
        {
            return new TabSolarizedDark(content);
        }
        ...
        {
            get { return SolarizedDarkAutoHideStrip.GraphicsPath; }
        }
        ...
        public SolarizedDarkDockPaneStrip(DockPane pane)
            : base(pane)
        {
        ...
        private void CalculateTabs_ToolWindow()
        {
            ...
            foreach (TabSolarizedDark tab in Tabs)
            {
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            var tab = Tabs[index] as TabSolarizedDark;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                var tab = Tabs[m_startDisplayingTab] as TabSolarizedDark;
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            TabSolarizedDark tabActive = null;
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    tabActive = Tabs[i] as TabSolarizedDark;
                    continue;
                }
                if (rectTab.IntersectsWith(rectTabOnly))
                    DrawTab(g, Tabs[i] as TabSolarizedDark, rectTab);
            }
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            ...
            for (int i = 0; i < Tabs.Count; i++)
                DrawTab(g, Tabs[i] as TabSolarizedDark, GetTabRectangle(i));
        }
        ...
        private Rectangle GetTabRectangle_ToolWindow(int index)
        {
            ...
            TabSolarizedDark tab = (TabSolarizedDark)(Tabs[index]);
        ...
        {
            Rectangle rectTabStrip = TabStripRectangle;
            var tab = (TabSolarizedDark)Tabs[index];
        ...
        private void DrawTab(Graphics g, TabSolarizedDark tab, Rectangle rect)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
        ...
        private void DrawTab_ToolWindow(Graphics g, TabSolarizedDark tab, Rectangle rect)
        {
            rect.Y += 1;
        ...
        private void DrawTab_Document(Graphics g, TabSolarizedDark tab, Rectangle rect)
        {
            if (tab.TabWidth == 0)
                return;
