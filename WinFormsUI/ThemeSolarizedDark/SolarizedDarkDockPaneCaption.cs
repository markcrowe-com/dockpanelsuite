...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class SolarizedDarkDockPaneCaption : DockPaneCaptionBase
    {
        private sealed class InertButton : InertButtonBase
        {
            private Bitmap m_image, m_imageAutoHide;

            public InertButton(SolarizedDarkDockPaneCaption dockPaneCaption, Bitmap image, Bitmap imageAutoHide)
                : base()
            {
            ...
            private SolarizedDarkDockPaneCaption m_dockPaneCaption;
            private SolarizedDarkDockPaneCaption DockPaneCaption
            {
        ...
        public SolarizedDarkDockPaneCaption(DockPane pane) : base(pane)
        {
            SuspendLayout();
