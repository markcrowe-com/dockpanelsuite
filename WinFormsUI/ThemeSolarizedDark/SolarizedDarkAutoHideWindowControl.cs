...
{
    internal class SolarizedDarkAutoHideWindowControl : DockPanel.AutoHideWindowControl
    {
        private class SolarizedDarkAutoHideWindowSplitterControl : SplitterBase
        {
            ...
            public SolarizedDarkAutoHideWindowSplitterControl(DockPanel.AutoHideWindowControl autoHideWindow)
            {
        ...
        public SolarizedDarkAutoHideWindowControl(DockPanel dockPanel) : base(dockPanel)
        {
            m_splitter = new SolarizedDarkAutoHideWindowSplitterControl(this);
