    ...
    internal class VS2012DockPaneStrip : DockPaneStripBase
    {
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                if (rectTab.IntersectsWith(rectTabOnly))
                    DrawTab(g, Tabs[i] as TabVS2012, rectTab);
            }
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            ...
            for (int i = 0; i < Tabs.Count; i++)
                DrawTab(g, Tabs[i] as TabVS2012, GetTabRectangle(i));
        }
        ...
        private void DrawTab(Graphics g, TabVS2012 tab, Rectangle rect)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
        ...
        private void DrawTab_ToolWindow(Graphics g, TabVS2012 tab, Rectangle rect)
        {
            rect.Y += 1;
