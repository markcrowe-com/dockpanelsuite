...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class SolarizedLightDockPaneStrip : DockPaneStripBase
    {
        private class TabSolarizedLight : Tab
        {
            public TabSolarizedLight(IDockContent content)
                : base(content)
            {
            }
        ...
        {
            return new TabSolarizedLight(content);
        }
        ...
        {
            get { return SolarizedLightAutoHideStrip.GraphicsPath; }
        }
        ...
        public SolarizedLightDockPaneStrip(DockPane pane)
            : base(pane)
        {
        ...
        private void CalculateTabs_ToolWindow()
        {
            ...
            foreach (TabSolarizedLight tab in Tabs)
            {
        ...
        private bool CalculateDocumentTab(Rectangle rectTabStrip, ref int x, int index)
        {
            ...
            var tab = Tabs[index] as TabSolarizedLight;
        ...
        private void CalculateTabs_Document()
        {
            ...
            {
                int tempX = x;
                var tab = Tabs[m_startDisplayingTab] as TabSolarizedLight;
        ...
        private void DrawTabStrip_Document(Graphics g)
        {
            ...
            TabSolarizedLight tabActive = null;
            ...
            for (int i = 0; i < count; i++)
            {
                ...
                {
                    tabActive = Tabs[i] as TabSolarizedLight;
                    continue;
                }
                if (rectTab.IntersectsWith(rectTabOnly))
                    DrawTab(g, Tabs[i] as TabSolarizedLight, rectTab);
            }
        ...
        private void DrawTabStrip_ToolWindow(Graphics g)
        {
            ...
            for (int i = 0; i < Tabs.Count; i++)
                DrawTab(g, Tabs[i] as TabSolarizedLight, GetTabRectangle(i));
        }
        ...
        private Rectangle GetTabRectangle_ToolWindow(int index)
        {
            ...
            TabSolarizedLight tab = (TabSolarizedLight)(Tabs[index]);
        ...
        {
            Rectangle rectTabStrip = TabStripRectangle;
            var tab = (TabSolarizedLight)Tabs[index];
        ...
        private void DrawTab(Graphics g, TabSolarizedLight tab, Rectangle rect)
        {
            if (Appearance == DockPane.AppearanceStyle.ToolWindow)
        ...
        private void DrawTab_ToolWindow(Graphics g, TabSolarizedLight tab, Rectangle rect)
        {
            rect.Y += 1;
        ...
        private void DrawTab_Document(Graphics g, TabSolarizedLight tab, Rectangle rect)
        {
            if (tab.TabWidth == 0)
                return;
