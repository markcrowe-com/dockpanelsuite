...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    internal class SolarizedLightDockPaneCaption : DockPaneCaptionBase
    {
        private sealed class InertButton : InertButtonBase
        {
            private Bitmap m_image, m_imageAutoHide;

            public InertButton(SolarizedLightDockPaneCaption dockPaneCaption, Bitmap image, Bitmap imageAutoHide)
                : base()
            {
            ...
            private SolarizedLightDockPaneCaption m_dockPaneCaption;
            private SolarizedLightDockPaneCaption DockPaneCaption
            {
        ...
        public SolarizedLightDockPaneCaption(DockPane pane) : base(pane)
        {
            SuspendLayout();
