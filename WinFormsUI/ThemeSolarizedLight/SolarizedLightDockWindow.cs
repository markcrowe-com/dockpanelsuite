...
namespace WeifenLuo.WinFormsUI.Docking
{
    ...
    /// </summary>
    [ToolboxItem(false)]
    internal class SolarizedLightDockWindow : DockWindow
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="SolarizedLightDockWindow"/> class.
        /// </summary>
        /// <param name="dockPanel">The dock panel.</param>
        /// <param name="dockState">State of the dock.</param>
        public SolarizedLightDockWindow(DockPanel dockPanel, DockState dockState) : base(dockPanel, dockState)
        {
        }
        ...
        internal class SolarizedLightDockWindowSplitterControl : SplitterBase
        {
