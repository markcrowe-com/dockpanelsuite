...
{
    internal class SolarizedLightAutoHideWindowControl : DockPanel.AutoHideWindowControl
    {
        private class SolarizedLightAutoHideWindowSplitterControl : SplitterBase
        {
            ...
            public SolarizedLightAutoHideWindowSplitterControl(DockPanel.AutoHideWindowControl autoHideWindow)
            {
        ...
        public SolarizedLightAutoHideWindowControl(DockPanel dockPanel) : base(dockPanel)
        {
            m_splitter = new SolarizedLightAutoHideWindowSplitterControl(this);
